...
<head>
    ...
    <title>Sistem Informasi Klinik Gigi Smile Care Cibinong</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand">
                    <a href=""><span class="text-primary">Klinik Gigi</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?= base_url('tindakan/data.php') ?>">Info Biaya Tindakan</a>
                </li>
                <li>
                    <a href="<?= base_url('obat/data.php') ?>">Info Obat</a>
                </li>
                <li>
                    <a href="<?= base_url('rekammedis/data.php') ?>">Rekam Medis</a>
                </li>
                 <li>
                    <a href="<?= base_url('resep/data.php') ?>">Resep</a>
                </li>
                <li>
                    <a href="<?= base_url('pembayaran/data.php') ?>">Pembayaran</a>
                </li>
                <li>
